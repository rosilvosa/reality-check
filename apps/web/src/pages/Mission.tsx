...
export default function Mission() {
  ...
  return (
    <div>
      ...
      <p className="text-[0.6875rem] tracking-[0.18em] uppercase text-muted mb-1">{t.mission.tag}</p>
      ...
      <div className="space-y-3 mb-6">
        <div className="bg-surface border border-border rounded-xl p-5">
          <p className="text-ink font-bold text-[0.9375rem] mb-1">{t.mission.belief1Title}</p>
          <p className="text-sm text-muted leading-relaxed">{t.mission.belief1Body}</p>
        </div>
        <div className="bg-surface border border-border rounded-xl p-5">
          <p className="text-ink font-bold text-[0.9375rem] mb-1">{t.mission.belief2Title}</p>
      ...
      <div className="space-y-3 mb-6">
        <div className="bg-surface border border-border rounded-xl p-5">
          <p className="text-ink font-bold text-[0.9375rem] mb-1">{t.mission.how1Title}</p>
          <p className="text-sm text-muted leading-relaxed">{t.mission.how1Body}</p>
        </div>
        <div className="bg-surface border border-border rounded-xl p-5">
          <p className="text-ink font-bold text-[0.9375rem] mb-1">{t.mission.how2Title}</p>
