...
export const en: Translation = {
  ...
  home: {
    ...
    communityHint: 'Tips, wins, questions. Always anonymous.',
  },
  ...
  settings: {
    ...
    supportHint: 'Optional. Keeps cloud sync on for the next person. The app stays free either way.',
    kofiBtn: 'Ko-fi',
    ...
    communityDesc: 'Anonymous tips, wins, and hard days',
  ...
  community: {
    ...
    hero: 'Share a tip, a win, a question, or a hard day. No names. No betting talk that tells someone where to play.',
    filterAll: 'Feed',
    filterTips: 'Tips',
    filterWins: 'Wins',
    ...
    rules: 'No betting links. No asking for money. No targeting anyone.',
    deletePost: 'Remove',
    posting: 'POSTING…',
