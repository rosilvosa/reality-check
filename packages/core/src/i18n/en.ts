...
export const en: Translation = {
  ...
  home: {
    ...
    whyHint: 'The box, the near-miss, why the game will not let go',
  ...
  settings: {
    ...
    supportSection: 'If this helped',
    supportHint: 'Optional. GCash, Maya, or card. The app stays free. This keeps cloud sync on and helps David’s Beacon stay free for families.',
    kofiBtn: 'Ko-fi',
    ...
    sourceHint: 'MIT. Run your own copy. Keep the name Reality Check and append your country.',
