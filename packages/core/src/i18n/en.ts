...
export const en: Translation = {
  ...
  settings: {
    ...
    supportHint: 'Only if you can comfortably spare it. The app is free either way — this just covers server costs. If money is tight right now, keep it. That is the whole point of this app.',
    kofiBtn: 'Ko-fi',
